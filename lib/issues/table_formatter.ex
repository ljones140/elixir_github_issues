defmodule Issues.TableFormatter do
  ...
  That is, eacg header identifies a column, and those columns are extracted and
  ...
  @doc """
  Given a lost of rows, where eacj row contains a keyed list of columns, return
